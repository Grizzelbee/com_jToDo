...
// @package     : com_jTODO                                             //
// @file        : admin/views/notification/tmpl/edit.php                //
// @implements  :                                                       //
// @description : Template for the single Notification Edit-View        //
// Version      : 2.1.0                                                 //
// *********************************************************************//
...
<form action="<?php echo JRoute::_($url.(int) $this->item->id); ?>"method="post" name="adminForm" id="adminForm">
    ...
    <div>
        <input type="hidden" name="task" value="jtodo.notification" />
